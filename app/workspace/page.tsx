...
export default function WorkspacePage() {
  ...
  const [workItems, setWorkItems] = React.useState<WorkItem[]>([
    ...
    },
    {
      id: "3",
      title: "代码评审",
      date: formatDateString(addDays(new Date(), 3)),
      type: "review",
      color: "bg-purple-500",
    },
    {
      id: "4",
      title: "SR-2024-002 截止日期",
      date: formatDateString(addDays(new Date(), 5)),
      type: "deadline",
      color: "bg-red-500",
    },
  ])
  ...
  // 获取近期需要排查的需求（按截止日期和优先级排序）
  const urgentRequirements = React.useMemo(() => {
  ...
  // 删除工作安排
  function handleDeleteWorkItem(id: string) {
